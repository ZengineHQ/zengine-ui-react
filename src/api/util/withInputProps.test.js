...
test('it does nothing if no relevant props exist', () => {
  ...
  expect(container.firstChild).not.toHaveAttribute('readOnly');
  expect(container.firstChild).not.toHaveAttribute('class');
  expect(container.firstChild).not.toHaveAttribute('disabled');
  expect(container.firstChild).not.toHaveAttribute('required');
  expect(container.firstChild).not.toHaveAttribute('onChange');
  expect(container.firstChild).not.toHaveAttribute('onBlur');
